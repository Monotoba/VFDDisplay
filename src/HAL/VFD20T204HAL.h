...
// VFD20T204HAL: Generic HAL for 20x4 HD44780-like VFD modules
// Implements Function Set, Display Control, Clear, Entry Mode, DDRAM/CGRAM addressing
class VFD20T204HAL : public IVFDHAL {
public:
    VFD20T204HAL();
    ~VFD20T204HAL() override = default;

...
// VFDM202MD15HAL: HAL for Futaba M202MD15AJ (20x2) VFD module
// Implements HD44780-like instructions with Function Set brightness (BR1/BR0)
class VFDM202MD15HAL : public IVFDHAL {
public:
    VFDM202MD15HAL();
    ~VFDM202MD15HAL() override = default;
    ...
    bool _displayControl(bool displayOn, bool cursorOn, bool blinkOn);
